...
// @version      1.0.0
// @description  把 /calendar 的密集 7 列网格替换为按天分列的时间轴视图：每天显示当天放送的剧集（封面+集数+标题），今天高亮，支持左右切换日期
// @description:zh-CN 把 /calendar 的密集 7 列网格替换为按天分列的时间轴视图
// @author       qbs
...
(() => {
  ...
  GM_addStyle(`
    ...
    .bct-ep .info .ep { font-size: 11px; color: #f0911e; margin-top: 2px; }
